...
public class SidebarPanel extends JPanel {
     ...
     */
    public JButton addNavButton(String text, String icon, String cardName, boolean isDefault) {
    ...
    /**
     * Selects a button by its card name
     *
     * @param cardName The name of the card associated with the button
     */
    public void selectButton(String cardName) {
        JButton button = buttonMap.get(cardName);
        if (button != null) {
            updateButtonStyles(button);
            if (contentCardLayout != null && contentPanel != null) {
                contentCardLayout.show(contentPanel, cardName);
     ...
     */
    public void addNavButtonActionListener(String cardName, ActionListener listener) {
        JButton button = buttonMap.get(cardName);
        if (button != null) {
